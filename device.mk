...
PRODUCT_COPY_FILES += \
    ...
    device/lge/hammerhead/permissions/qcrilhook.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/qcrilhook.xml \
    device/lge/hammerhead/permissions/serviceitems.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/serviceitems.xml
...
PRODUCT_COPY_FILES += \
    ...
    device/lge/hammerhead/nfc/libnfc-brcm.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-brcm.conf \
    device/lge/hammerhead/nfc/libnfc-brcm-20791b05.conf:$(TARGET_COPY_OUT_VENDOR)/etc/libnfc-brcm-20791b05.conf
...
# For testing
PRODUCT_COPY_FILES += \
    device/lge/hammerhead/DxHDCP.cfg:$(TARGET_COPY_OUT_VENDOR)/etc/DxHDCP.cfg \
    device/lge/hammerhead/flp.conf:$(TARGET_COPY_OUT_VENDOR)/etc/flp.conf \
    device/lge/hammerhead/qcril.db:$(TARGET_COPY_OUT_VENDOR)/etc/qcril.db
...
# GPS configuration
PRODUCT_COPY_FILES += \
    device/lge/hammerhead/gps.conf:$(TARGET_COPY_OUT_VENDOR)/etc/gps.conf
